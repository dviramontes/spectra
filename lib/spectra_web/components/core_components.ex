defmodule SpectraWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpectraWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpectraWeb.Gettext, "errors", msg, opts)
    end
  end
